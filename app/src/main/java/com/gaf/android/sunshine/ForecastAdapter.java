...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
     ...
     * our RecyclerView
     */
    private final ForecastAdapterOnClickHandler mforecastOnClickHandler;
     ...
     *
     * @param forecastOnClickHandler The on-click handler for this adapter. This single handler is called
     *                     when an item is clicked.
     */
    public ForecastAdapter(ForecastAdapterOnClickHandler forecastOnClickHandler){
        this.mforecastOnClickHandler = forecastOnClickHandler;
    }
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            mforecastOnClickHandler.onClick(weatherForDay);
        }
    }
}
